...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/assets/img/slide_1_1.jpg" class="d-block w-100 carousel-img" alt="...">
            ...
            <div class="carousel-item">
                <img src="/assets/img/slide_3_3.jpg" class="d-block w-100 carousel-img" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="row mt-5">
                <div class="col-md-6" data-aos="fade-right">
                    <h3 class="fw-bold about-us-title">
                        PT. Pundi Mas Corporations
                    </h3>
                    <p class="fw-bolder mt-4 about-us-subtitle">
                        PT. Pundi Mas Corporations founded in 2010, is an lnternatonal freight forwarding Company and also the first logistics company starting professional overseas personal & machineries mover project, also handling for General commodity export.
                    </p>
                </div>
    ...
    <div class="services mt-5 bg-light py-5">
        <div class="container">
            ...
            <p class="text-center mt-4" data-aos="zoom-in" data-aos-duration="1500">
    ...
    <div class="clients mt-5">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-3 pt-5 text-center m-auto" data-aos="zoom-in">
