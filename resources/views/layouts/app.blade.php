...
<head>
    ...
    <!-- Theme style -->
    <link href="/lte/dist/css/adminlte.min.css" rel="stylesheet">
</head>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="dashboard" class="brand-link">
                <img src="/lte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Pundi Mas Corporations</span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/product_1" class="nav-link">
                                        <i class="nav-icon fa fa-cube"></i>
                                        <p>Product 1</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/product_2" class="nav-link">
                                        <i class="nav-icon fa fa-cube"></i>
                                        <p>Product 2</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/product_3" class="nav-link">
                                        <i class="nav-icon fa fa-cube"></i>
                                        <p>Product 3</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/product_4" class="nav-link">
                                        <i class="nav-icon fa fa-cube"></i>
                                        <p>Product 4</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/product_5" class="nav-link">
                                        <i class="nav-icon fa fa-cube"></i>
                                        <p>Product 5</p>
                                    </a>
                                </li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} <a href="">Pundi Mas Corporations</a>.</strong> All
            rights
            reserved.
        </footer>
    </div>
